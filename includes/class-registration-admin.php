...
class RT_Employee_Manager_Registration_Admin {
    ...
    private function render_pending_registrations() {
                        ...
                        <tr data-registration-id="<?php echo esc_attr($registration->id); ?>">
                            <td>
                                ...
                                <?php if ($registration->company_city): ?>
                                    <br><small><?php echo esc_html($registration->company_city); ?>, <?php echo esc_html($registration->company_country); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                ...
                                <div class="registration-detail-content">
                                    ...
                                    <div class="detail-columns">
                                        <div class="detail-column">
                                            ...
                                            <?php endif; ?>
                                            <p><strong><?php _e('Email:', 'rt-employee-manager'); ?></strong> <?php echo esc_html($registration->company_email); ?></p>
                                            <?php if ($registration->company_phone): ?>
                                                <p><strong><?php _e('Phone:', 'rt-employee-manager'); ?></strong> <?php echo esc_html($registration->company_phone); ?></p>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="detail-column">
                                            ...
                                            <?php if ($registration->company_postcode || $registration->company_city): ?>
                                                <p><?php echo esc_html($registration->company_postcode . ' ' . $registration->company_city); ?></p>
                                            <?php endif; ?>
                                        ...
                                        <div class="detail-column">
                                            ...
                                            <p><strong><?php _e('Name:', 'rt-employee-manager'); ?></strong> <?php echo esc_html($registration->contact_first_name . ' ' . $registration->contact_last_name); ?></p>
                                            <p><strong><?php _e('Email:', 'rt-employee-manager'); ?></strong> <?php echo esc_html($registration->contact_email); ?></p>
                                        </div>
                                        
                                        <div class="detail-column">
                                            <h5><?php _e('Technical Details', 'rt-employee-manager'); ?></h5>
                                            <p><strong><?php _e('IP Address:', 'rt-employee-manager'); ?></strong> <?php echo esc_html($registration->ip_address); ?></p>
                                            <p><strong><?php _e('Submitted:', 'rt-employee-manager'); ?></strong> <?php echo wp_date(get_option('date_format') . ' ' . get_option('time_format'), strtotime($registration->submitted_at)); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </td>
        ...
        <div id="rejection-modal" style="display: none;">
            <div class="rejection-modal-content">
                ...
                <textarea id="rejection-reason" rows="4" cols="50" placeholder="<?php esc_attr_e('Reason for rejection...', 'rt-employee-manager'); ?>"></textarea>
                <div class="modal-actions">
                    <button type="button" id="confirm-rejection" class="button button-primary"><?php _e('Reject', 'rt-employee-manager'); ?></button>
                    <button type="button" id="cancel-rejection" class="button"><?php _e('Cancel', 'rt-employee-manager'); ?></button>
                </div>
            </div>
        </div>
    ...
    private function render_approved_registrations() {
        ...
        ?>
        <p><?php _e('Companies that have been approved and have active accounts.', 'rt-employee-manager'); ?></p>
