...
class RT_Employee_Manager
{
    ...
    private function cleanup_capabilities_on_deactivation()
    {
        ...
        $capabilities_to_remove = array(
            'create_employees',
            'edit_employees',
            'edit_others_employees',
            'publish_employees',
            'read_employee',
            'read_private_employees',
            'delete_employees',
            'delete_others_employees',
            'delete_private_employees',
            'delete_published_employees',
            'edit_private_employees',
            'edit_published_employees',
            'create_clients',
            'edit_clients',
            'edit_others_clients',
            'publish_clients',
